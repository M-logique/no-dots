...
var init_start = __esm({
  "src/handlers/start.ts"() {
    ...
    startHandler = {
      name: "start",
      canHandle: /* @__PURE__ */ __name((message) => message.text?.startsWith("/start") ?? false, "canHandle"),
      handle: /* @__PURE__ */ __name(async (message, bot) => {
        const startMessage = `\u0633\u0644\u0627\u0645!
...
// src/handlers/default-inline.ts
var default_inline_exports = {};
__export(default_inline_exports, {
  defaultInlineHandler: () => defaultInlineHandler
});
var defaultInlineHandler;
var init_default_inline = __esm({
  "src/handlers/default-inline.ts"() {
    "use strict";
    defaultInlineHandler = {
      name: "default-inline",
      canHandle: /* @__PURE__ */ __name((query) => true, "canHandle"),
      handle: /* @__PURE__ */ __name(async (query, bot) => {
        const results = [
          {
            type: "article",
            id: "default",
            title: "\u0634\u0631\u0648\u0639 \u0628\u0647 \u062A\u0627\u06CC\u067E \u06A9\u0646 \u062A\u0627 \u0646\u0642\u0637\u0647\u200C\u0647\u0627 \u0631\u0648 \u062D\u0630\u0641 \u06A9\u0646\u0645",
            description: "\u0647\u0631\u0686\u06CC \u0627\u06CC\u0646\u062C\u0627 \u0628\u0646\u0648\u06CC\u0633\u06CC\u060C \u0645\u0646 \u0646\u0642\u0637\u0647\u200C\u0647\u0627\u0634\u0648 \u0628\u0631\u0627\u062A \u067E\u0627\u06A9 \u0645\u06CC\u200C\u06A9\u0646\u0645.",
            input_message_content: {
              message_text: "\u0628\u0631\u0627\u06CC \u0627\u0633\u062A\u0641\u0627\u062F\u0647 \u0627\u0632 \u0631\u0628\u0627\u062A\u060C \u0628\u0639\u062F \u0627\u0632 \u0627\u0633\u0645 \u0645\u0646\u060C \u0645\u062A\u0646\u062A \u0631\u0648 \u0628\u0646\u0648\u06CC\u0633 \u062A\u0627 \u0628\u062F\u0648\u0646 \u0646\u0642\u0637\u0647 \u062A\u062D\u0648\u06CC\u0644 \u0628\u06AF\u06CC\u0631\u06CC.",
              parse_mode: "Markdown"
            }
          }
        ];
...
var init_functions = __esm({
  "src/utils/functions.ts"() {
    "use strict";
    __name(removeDots, "removeDots");
  }
});

// src/handlers/replacer.ts
var replacer_exports = {};
__export(replacer_exports, {
  replacerHandler: () => replacerHandler
});
var replacerHandler;
var init_replacer = __esm({
  "src/handlers/replacer.ts"() {
    ...
    replacerHandler = {
      name: "replacer",
      canHandle: /* @__PURE__ */ __name((query) => query.query.trim() != "", "canHandle"),
      handle: /* @__PURE__ */ __name(async (query, bot) => {
        const text = query.query;
        const dotlessText = removeDots(text);
        const results = [
          {
            type: "article",
            id: "replacer",
            title: "\u0645\u062A\u0646 \u0628\u062F\u0648\u0646 \u0646\u0642\u0637\u0647",
            description: dotlessText,
            input_message_content: {
...
var TelegramBot = class {
  ...
  async sendMessage(chatId, text, parseMode, disableWebPagePreview) {
  ...
  async replyToMessage(chatId, messageId, text, parseMode, disableWebPagePreview) {
    const body = { chat_id: chatId, reply_to_message_id: messageId, text };
    if (parseMode) body.parse_mode = parseMode;
    if (disableWebPagePreview !== void 0) body.disable_web_page_preview = disableWebPagePreview;
    const response = await fetch(`${this.baseUrl}/sendMessage`, {
      method: "POST",
  ...
  async editInlineMessageText(inlineMessageId, text, replyMarkup, parseMode) {
    const body = { inline_message_id: inlineMessageId, text };
    if (replyMarkup) body.reply_markup = replyMarkup;
    if (parseMode) body.parse_mode = parseMode;
    const response = await fetch(`${this.baseUrl}/editMessageText`, {
      method: "POST",
...
var HandlerRegistry = class {
  ...
  async processMessage(message, bot, allowedIds) {
  ...
  async processInlineQuery(query, bot, allowedIds) {
  ...
  async processCallbackQuery(callbackQuery, bot, allowedIds) {
...
async function loadHandlers(registry) {
  const { startHandler: startHandler2 } = await Promise.resolve().then(() => (init_start(), start_exports));
  registry.register(startHandler2);
  const { defaultInlineHandler: defaultInlineHandler2 } = await Promise.resolve().then(() => (init_default_inline(), default_inline_exports));
  const { replacerHandler: replacerHandler2 } = await Promise.resolve().then(() => (init_replacer(), replacer_exports));
  registry.registerInline(defaultInlineHandler2);
  registry.registerInline(replacerHandler2);
}
__name(loadHandlers, "loadHandlers");
app.notFound((c) => {
